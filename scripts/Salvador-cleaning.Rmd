...
zonas_sv <- tribble(
  ...
  # --- San Salvador (06) ---
  6, "San Salvador", "SVSS", 1, "San Salvador Centro",
  6, "San Salvador", "SVSS", 2, "San Salvador Este",
  6, "San Salvador", "SVSS", 3, "San Salvador Norte",
  6, "San Salvador", "SVSS", 4, "San Salvador Oeste",
  6, "San Salvador", "SVSS", 5, "San Salvador Sur",

  # --- Cuscatlán (07) ---
  7, "Cuscatlán", "SVCU", 1, "Cuscatlán Norte",
  7, "Cuscatlán", "SVCU", 2, "Cuscatlán Sur",

  # --- La Paz (08) ---
  8, "La Paz", "SVPA", 1, "La Paz Centro",
  8, "La Paz", "SVPA", 2, "La Paz Este",
  8, "La Paz", "SVPA", 3, "La Paz Oeste",
  ...
  # --- San Vicente (10) ---
  10, "San Vicente", "SVSV", 1, "San Vicente Norte",
  10, "San Vicente", "SVSV", 2, "San Vicente Sur",

  # --- Usulután (11) ---
  11, "Usulután", "SVUS", 1, "Usulután Este",
  11, "Usulután", "SVUS", 2, "Usulután Norte",
  11, "Usulután", "SVUS", 3, "Usulután Oeste",

  # --- San Miguel (12) ---
  12, "San Miguel", "SVSM", 1, "San Miguel Centro",
  12, "San Miguel", "SVSM", 2, "San Miguel Norte",
  12, "San Miguel", "SVSM", 3, "San Miguel Oeste",

  # --- Morazán (13) ---
  13, "Morazán", "SVMO", 1, "Morazán Norte",
  13, "Morazán", "SVMO", 2, "Morazán Sur",

  # --- La Unión (14) ---
  14, "La Unión", "SVUN", 1, "La Unión Norte",
  14, "La Unión", "SVUN", 2, "La Unión Sur"
)

```

```{r}
zonas_sv_depto <- zonas_sv %>%
...
```{r}
poblacion <- read_csv(
  "../Data/raw/El Salvador/Censo Poblacion & Vivienda 2024/Base de Datos de Población - CPV 2024 SV.csv"
) 

```
```{r}
hogares<- read_csv(
  "../Data/raw/El Salvador/Censo Poblacion & Vivienda 2024/Base de Datos de Hogares - CPV 2024 SV.csv",
  locale = locale(encoding = "UTF-8"),
) %>% clean_names()
```
```{r}
emigration<- read_csv(
  "../Data/raw/El Salvador/Censo Poblacion & Vivienda 2024/Base de Datos de Emigración Internacional - CPV 2024 SV.csv",
  locale = locale(encoding = "UTF-8"),
) %>% clean_names()
```

```{r}
poblacion <- clean_names(poblacion)
poblacion
```
...
base_muni <- base_muni %>%
  filter(dep_codigo < 15) # 15 is used for non departmeny asigned ones
...
```{r}
write_csv(base_muni,
          "../Data/clean/municipality_summary_slv.csv")
```
...
write_csv(emigration_summary,
          "../Data/clean/emigration_summary_slv.csv")
```
