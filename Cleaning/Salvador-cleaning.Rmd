...
```{r}
poblacion <- read_csv(
  "~/Desktop/UchicagoPolicyLab-Migration/Data/El Salvador/Raw Data /Base de Datos de Población - CPV 2024 SV.csv",
...
```{r}
hogares<- read_csv(
  "~/Desktop/UchicagoPolicyLab-Migration/Data/El Salvador/Raw Data /Base de Datos de Hogares - CPV 2024 SV.csv",
  locale = locale(encoding = "UTF-8"),
) %>% clean_names()
...
```{r}
write_csv(base_muni,
          "../Data/El Salvador/Processed/municipality_summary.csv")
```
...
```{r}
emigration<- read_csv(
  "~/Desktop/UchicagoPolicyLab-Migration/Data/El Salvador/Raw Data /Base de Datos de Emigración Internacional - CPV 2024 SV.csv",
  locale = locale(encoding = "UTF-8"),
) %>% clean_names()
...
write_csv(emigration_summary,
          "../Data/El Salvador/Processed/emigration_summary.csv")
```
